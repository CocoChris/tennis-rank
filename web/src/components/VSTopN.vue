<template>
  <div style="height:100%;width:100%">
    <div class="selectContainer">
      ...
      <el-input v-model="player2Select"
                clearable
                placeholder="Top N"
                prefix-icon="el-icon-arrow-right"
                class="playerSelect"> </el-input>
    </div>
    ...
    <div v-if="!loading"
      ...
      <el-table :data="resultData"
                style="font-size: medium;overflow: visible !important;"
...
export default {
  ...
  methods: {
    ...
    getJsonInfo: function (player1Id, player2Id) {
      this.$http
        .get('/api/h2h/vsTopN?playerId=' + player1Id + '&topN=' + player2Id)
        // eslint-disable-next-line
        .then(function (response) {
          ...
          // Player1
          this.$set(this.player1, 'name', resdata.playerName)
          this.$set(this.player1, 'rank', resdata.playerRank)
          this.$set(this.player1, 'wins', resdata.winsOfPlayer)

          // Player2
          var tmpId = 'Top ' + player2Id
          this.$set(this.player2, 'name', tmpId)
          this.$set(this.player2, 'rank', player2Id)
          this.$set(this.player2, 'wins', resdata.winsOfTopN)
